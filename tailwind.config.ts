...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'level-1': '0 2px 4px -2px rgba(0, 0, 0, 0.1)',
        'level-2': '0 8px 16px -4px rgba(0, 0, 0, 0.1)',
        'level-3': '0 24px 32px -8px rgba(0, 0, 0, 0.15)',
        'level-4': '0 32px 48px -12px rgba(0, 0, 0, 0.2)',
