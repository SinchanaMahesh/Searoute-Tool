...
const EnhancedSearchChat = ({ initialQuery, searchType, resultCount, quickFilters = [] }: EnhancedSearchChatProps) => {
  ...
  return (
    <div className="h-full flex flex-col bg-white overflow-hidden">
      ...
      {/* Messages - Scrollable area with fixed height calculation */}
      ...
      {/* Quick Filters - Fixed height, always visible */}
      {quickFilters.length > 0 && (
        <div className="px-3 py-2 border-t border-border-gray bg-pearl-white flex-shrink-0" style={{ minHeight: '60px' }}>
      ...
      <div className="p-3 border-t border-border-gray bg-pearl-white flex-shrink-0" style={{ minHeight: '80px' }}>
        <div className="flex items-center gap-2">
          <Button
            variant="outline"
            size="sm"
